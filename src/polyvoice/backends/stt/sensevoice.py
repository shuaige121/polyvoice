...
class SenseVoiceBackend:
    ...
    def _load(self) -> None:
        ...
        # TODO(spec): sherpa-onnx 1.12.38 `from_sense_voice` does not expose
        # `hotwords_file`; reload tracking is kept so this can be wired once the
        # SenseVoice constructor/API is pinned precisely.
